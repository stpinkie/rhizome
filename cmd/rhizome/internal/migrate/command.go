...
import (
	...
	"github.com/stpinkie/rhizome/pkg/migrate"
)
...
func NewMigrateCommand() *cobra.Command {
  ...
  rhizome migrate --dry-run
  rhizome migrate --refresh
  rhizome migrate --force`,
	...
	cmd.Flags().StringVar(&opts.TargetHome, "target-home", "",
		"Override target home directory (default: ~/.rhizome)")
