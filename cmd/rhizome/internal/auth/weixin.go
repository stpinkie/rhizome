...
import (
	...
	"github.com/stpinkie/rhizome/pkg/channels/weixin"
...
to authorize your account. On success, the bot token is saved to the rhizome
...
func printManualWeixinConfig(token, baseURL string) {
	fmt.Println()
	fmt.Println("Add the following to the channels section of your rhizome config:")
	fmt.Println()
	fmt.Println(`  "weixin": {`)
