...
func printOnboardPlain(logo string, encrypt bool, configPath string) {
	...
	fmt.Println("\nNext steps:")
	if encrypt {
		fmt.Println("  1. Set your encryption passphrase before starting rhizome:")
		fmt.Println("       export RHIZOME_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS")
		fmt.Println("       set RHIZOME_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd")
		fmt.Println("")
	...
	fmt.Println("")
	if encrypt {
		fmt.Println("  3. Chat: rhizome agent -m \"Hello!\"")
	} else {
		fmt.Println("  2. Chat: rhizome agent -m \"Hello!\"")
	}
}
...
func printOnboardFancy(logo string, encrypt bool, configPath string) {
	...
	ready := titleBarStyle().Render(logo+" rhizome is ready!") + "\n"
	fmt.Println()
...
func buildOnboardingSteps(encrypt bool, configPath string) string {
	...
	if encrypt {
		b.WriteString("1. Set your encryption passphrase before starting rhizome:\n")
		b.WriteString("   export RHIZOME_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS\n")
		b.WriteString("   set RHIZOME_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd\n\n")
