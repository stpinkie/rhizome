...
* **Channel**
  ...
  * [**attachment**](https://github.com/stpinkie/rhizome/issues/348): Native handling of images, audio, and video attachments.


* **Skill Marketplace**
  * [**Discovery skills**](https://github.com/stpinkie/rhizome/issues/287): Implement `find_skill` to automatically discover and install skills from the [GitHub Skills Repo] or other registries.
...
* **Operations**
  * [**MCP Support**](https://github.com/stpinkie/rhizome/issues/290): Native support for the **Model Context Protocol (MCP)**.
  * [**Browser Automation**](https://github.com/stpinkie/rhizome/issues/293): Headless browser control via CDP (Chrome DevTools Protocol) or ActionBook.
  * [**Mobile Operation**](https://github.com/stpinkie/rhizome/issues/292): Android device control (similar to BotDrop).
...
* [**QuickGuide (Zero-Config Start)**](https://github.com/stpinkie/rhizome/issues/350)
...
* [**Logo Design**](https://github.com/stpinkie/rhizome/issues/297): We are looking for a **Mantis Shrimp (Stomatopoda)** logo design!
