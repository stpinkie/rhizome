...
Le canal MaixCam permet à Rhizome de fonctionner comme backend IA pour les appareils en périphérie :

- **Surveillance intelligente** : MaixCAM envoie des images ; Rhizome les analyse via des modèles de vision
- **Contrôle IoT** : Les appareils envoient des données de capteurs ; Rhizome coordonne les réponses
- **IA hors ligne** : Déployer Rhizome sur un réseau local pour une inférence à faible latence
