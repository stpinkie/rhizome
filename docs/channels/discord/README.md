...
Discord is a free voice, video, and text chat application designed for communities. Rhizome connects to Discord servers via the Discord Bot API, supporting both receiving and sending messages.
...
```text
🔧 `web_search`
Checking the latest Rhizome release notes before I answer.
```
