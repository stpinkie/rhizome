...
Slack is a leading enterprise instant messaging platform. Rhizome uses Slack's Socket Mode for real-time bidirectional communication, with no need to configure a public webhook endpoint.
