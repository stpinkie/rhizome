...
Rhizome は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. Rhizome 設定ファイルに認証情報を入力する
4. `rhizome gateway` を実行してサービスを起動する
...
4. Rhizome 設定ファイルに認証情報を入力する
5. `rhizome gateway` を実行してサービスを起動する
