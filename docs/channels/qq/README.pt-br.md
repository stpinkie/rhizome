...
O Rhizome oferece suporte ao QQ via API Bot oficial da Plataforma Aberta QQ.
...
3. Preencha as credenciais no arquivo de configuração do Rhizome
4. Execute `rhizome gateway` para iniciar o serviço
...
4. Preencha as credenciais no arquivo de configuração do Rhizome
5. Execute `rhizome gateway` para iniciar o serviço
