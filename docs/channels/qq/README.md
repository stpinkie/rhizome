...
Rhizome provides QQ support via the official Bot API from the QQ Open Platform.
...
3. Fill in the credentials in the Rhizome configuration file
4. Run `rhizome gateway` to start the service
...
4. Fill in the credentials in the Rhizome configuration file
5. Run `rhizome gateway` to start the service
