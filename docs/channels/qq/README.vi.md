...
Rhizome hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình Rhizome
4. Chạy `rhizome gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình Rhizome
5. Chạy `rhizome gateway` để khởi động dịch vụ
