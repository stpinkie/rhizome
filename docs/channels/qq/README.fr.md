...
Rhizome prend en charge QQ via l'API Bot officielle de la plateforme ouverte QQ.
...
3. Renseigner les identifiants dans le fichier de configuration Rhizome
4. Exécuter `rhizome gateway` pour démarrer le service
...
4. Renseigner les identifiants dans le fichier de configuration Rhizome
5. Exécuter `rhizome gateway` pour démarrer le service
