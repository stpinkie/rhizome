...
Task-oriented guides for setup, configuration, and common Rhizome workflows.

- [Docker & Quick Start Guide](docker.md): install and run Rhizome with Docker or the launcher.
- [Android Termux Guide](android-termux.md): run the Rhizome terminal binary on an ARM64 Android phone.
