---
name: skill-creator
description: Create, update, or review Rhizome skills. Use when writing a new skill, modifying an existing SKILL.md, turning a repeated workflow into a reusable skill, or organizing scripts, references, and assets for a skill.
---
...
Create user-installed Rhizome skills under the workspace configured by Rhizome: `<workspace>/skills/<skill-name>/`. If Rhizome is configured to use a non-default workspace, set `WORKSPACE` to that path instead.

```bash
WORKSPACE="$HOME/.rhizome/workspace"
mkdir -p "$WORKSPACE/skills/my-skill"
cat > "$WORKSPACE/skills/my-skill/SKILL.md" <<'EOF'
---
name: my-skill
description: Describe what this skill does and when Rhizome should use it.
---
...
If Rhizome documents a packaging or validation command in the future, use that documented command rather than assuming a helper script exists.
