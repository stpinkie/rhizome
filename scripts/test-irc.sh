...
CONTAINER_NAME="rhizome-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.rhizome/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run rhizome:"
echo "  cd packages/rhizome && go run ./cmd/rhizome gateway"
echo ""
