...
// isRhizomeProcess uses QueryFullProcessImageNameW to confirm the
// process image name contains "rhizome". Returns false when the name
...
func isRhizomeProcess(pid int) bool {
	...
	return strings.Contains(name, "rhizome")
}
