...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/rhizome_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("RHIZOME_LOG_FILE", tmpFile)
	defer os.Unsetenv("RHIZOME_LOG_FILE")
	...
	os.Setenv("RHIZOME_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
