# Rhizome Channel System：完整开发指南

> **影响范围**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/rhizome/internal/gateway/`
...
import (
    "github.com/stpinkie/rhizome/pkg/bus"
    "github.com/stpinkie/rhizome/pkg/channels"     // 引用父包
    "github.com/stpinkie/rhizome/pkg/config"
    "github.com/stpinkie/rhizome/pkg/identity"      // 新增
    "github.com/stpinkie/rhizome/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/stpinkie/rhizome/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/stpinkie/rhizome/pkg/channels/discord"
    _ "github.com/stpinkie/rhizome/pkg/channels/your_new_channel"  // 新增
)
```
...
4. **Pico Protocol**：`pkg/channels/pico/` 实现了一个自定义的 Rhizome 原生协议 channel，通过 WebSocket webhook (`/pico/ws`) 接收消息。
