# Rhizome Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/rhizome/internal/gateway/`
...
import (
    "github.com/stpinkie/rhizome/pkg/bus"
    "github.com/stpinkie/rhizome/pkg/channels"     // Reference parent package
    "github.com/stpinkie/rhizome/pkg/config"
    "github.com/stpinkie/rhizome/pkg/identity"      // New
    "github.com/stpinkie/rhizome/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/rhizome/internal/gateway/helpers.go
import (
    _ "github.com/stpinkie/rhizome/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/stpinkie/rhizome/pkg/channels/discord"
    _ "github.com/stpinkie/rhizome/pkg/channels/your_new_channel"  // New addition
)
```
...
// cmd/rhizome/internal/gateway/helpers.go
import (
    _ "github.com/stpinkie/rhizome/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom Rhizome native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
