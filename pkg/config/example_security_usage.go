...
Edit ~/.rhizome/.security.yml and replace placeholders with your actual keys.

## Step 4: Simplify config.json (Recommended)
Remove sensitive fields from ~/.rhizome/config.json:
...
export RHIZOME_CHANNELS_DISCORD_TOKEN="discord-token-from-env"

# Web Tools
export RHIZOME_TOOLS_WEB_BRAVE_API_KEY="brave-key-from-env"
export RHIZOME_TOOLS_WEB_BAIDU_API_KEY="baidu-key-from-env"

# Skills
export RHIZOME_TOOLS_SKILLS_GITHUB_TOKEN="github-token-from-env"
```
