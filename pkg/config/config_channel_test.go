...
func TestInitChannelList_TelegramStreamingEnvCompatibility(t *testing.T) {
	t.Setenv("RHIZOME_CHANNELS_TELEGRAM_STREAMING_ENABLED", "true")
	t.Setenv("RHIZOME_CHANNELS_TELEGRAM_STREAMING_THROTTLE_SECONDS", "3")
	t.Setenv("RHIZOME_CHANNELS_TELEGRAM_STREAMING_MIN_GROWTH_CHARS", "120")
